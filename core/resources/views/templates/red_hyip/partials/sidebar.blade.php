...
<div class="dashboard__left">
    <div class="sidebar-menu">
        ...
        <div class="sidebar-user">
            ...
            <h5 class="sidebar-user__amount"> {{ $general->cur_sym }}{{ showAmount(auth()->user()->deposit_wallet) }} <span class="sidebar-user__wallet"> (@lang('Deposit Wallet'))</span> </h5>
            <h5 class="sidebar-user__amount"> {{ $general->cur_sym }}{{ showAmount(auth()->user()->interest_wallet) }} <span class="sidebar-user__wallet">(@lang('Interest Wallet'))</span> </h5>
        </div>
        ...
        <ul class="sidebar-menu-list">
            ...
            <li class="sidebar-menu-list__item ">
                <a href="{{ route('user.invest.statistics') }}" class="sidebar-menu-list__link {{ menuActive('user.invest.statistics') }}">
            ...
            @if ($general->schedule_invest)
                <li class="sidebar-menu-list__item ">
                    <a href="{{ route('user.invest.schedule') }}" class="sidebar-menu-list__link {{ menuActive('user.invest.schedule') }}">
                        <span class="icon"><i class="las la-calendar-check"></i></span>
            ...
            <li class="sidebar-menu-list__item">
                <a href="{{ route('user.transfer.balance') }}" class="sidebar-menu-list__link {{ menuActive('user.transfer.balance') }}">
            ...
            @if ($general->user_ranking)
                <li class="sidebar-menu-list__item">
                    <a href="{{ route('user.invest.ranking') }}" class="sidebar-menu-list__link {{ menuActive('user.invest.ranking') }}">
            ...
            @if ($general->promotional_tool && @$promotionCount)
                <li class="sidebar-menu-list__item">
                    <a href="{{ route('user.promotional.banner') }}" class="sidebar-menu-list__link {{ menuActive('user.promotional.banner') }}">
                ...
                <div class="sidebar-submenu {{ menuActive('ticket.*', 2) }}">
                    <ul class="sidebar-submenu-list">
                        <li class="sidebar-submenu-list__item {{ menuActive('ticket.open') }}">
                            <a href="{{ route('ticket.open') }}" class="sidebar-submenu-list__link">@lang('Ticket Open')</a>
                        </li>
                        <li class="sidebar-submenu-list__item {{ menuActive('ticket.index') }}">
                            <a href="{{ route('ticket.index') }} " class="sidebar-submenu-list__link">@lang('All Support Tickets') </a>
                        </li>
