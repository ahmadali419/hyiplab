    ...
    <div class="dashboard-header__inner">
        ...
        <div class="dashboard-header__left">
            <ul class="contact-list">
                <li class="contact-list__item"><a href="{{ route('ticket.open') }}" class="contact-list__link"> <span class="contact-list__link-icon"><i class="fas fa-headset"></i></span>
                        @lang('Support')</a></li>
                <li class="contact-list__item"><a href="mailto:{{ @$contactContent->data_values->support_email }}" class="contact-list__link"> <span class="contact-list__link-icon"><i class="fas fa-envelope"></i></span>
