@if ($general->user_ranking)
    ...
    @if ($userRankings->count())
        <section class="referral-level-section section-common-bg border-top-1 pt-120 pb-120">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="section_title_wrapper text-center mb-50">
                            <h2 class="section-title">
                                {{ __(@$userRanking->data_values->heading) }}
                            </h2>
                            <p class="section-subtitle margin-0 ">
                                {{ __(@$userRanking->data_values->sub_heading) }}
                            </p>
                        </div>
                    </div>
                </div>
