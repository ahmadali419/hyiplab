...
@section('content')
                                ...
                                <td class="text-end">
                                    ...
                                    @if ($scheduleInvest->rem_schedule_times)
                                        @if ($scheduleInvest->status)
                                            <button class="btn btn--base btn--sm confirmationBtn" data-question="@lang('Are you sure to pause this schedule invest?')" data-action="{{ route('user.invest.schedule.status', $scheduleInvest->id) }}">
                                                <i class="fas fa-pause"></i>
                                            </button>
                                        @else
                                            <button class="btn btn--base btn--sm confirmationBtn" data-question="@lang('Are you sure to continue this schedule invest?')" data-action="{{ route('user.invest.schedule.status', $scheduleInvest->id) }}">
    ...
    <div class="custom--modal">
        <x-confirmation-modal closeBtn="btn--danger btn-md" submitBtn="btn--primary btn-md" customModal="custom--modal" />
    </div>
@endsection
