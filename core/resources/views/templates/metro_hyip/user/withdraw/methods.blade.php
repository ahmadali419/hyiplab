...
@section('content')
    ...
    <section class="pt-120">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="card custom--card @if ($isHoliday && !$general->holiday_withdraw) card countdown-card @endif">
                    <div class="card-body">
                        ...
                        @else
                            <form action="{{ route('user.withdraw.money') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label for="method-code" class="form--label">@lang('Method')</label>
                                    <select class="form--control" id="method-code" name="method_code" required>
                                ...
                                <div class="form-group">
                                    <label for="withdraw-amount" class="form--label">@lang('Amount')</label>
                                    <div class="input-group">
                                        <input type="number" step="any" id="withdraw-amount" name="amount"
                                            value="{{ old('amount') }}" class="form-control form--control" required>
