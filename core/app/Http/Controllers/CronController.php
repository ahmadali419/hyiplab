...
class CronController extends Controller
{
  ...
  // Update the investments of the referrer
        $USERINVESTS//  = $refer->invests()->where('status', 1)->get();
        // foreach ($userInvests as $invest) {
        //     $invest->paid += $com; // Add commission to paid amount
        //     $invest->should_pay -= $com; // Deduct commission from should_pay amount
        //     $invest->save();
        // }
